...
upload path is configured. See
[`docs/symposium-plan/pillar-3-telemetry-schema.md`](https://github.com/peria-ai/precc-cc/blob/master/docs/symposium-plan/pillar-3-telemetry-schema.md)
for the schema, k-anonymity, and threat model.
